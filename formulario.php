...
<?php echo form_open("curso/recibirdatos") ?>
<?php

//creacion de arreglos para cada input
$usuario = array(
	'name'=>'usuario','placeholder'=>'escribe tu nombre'
	);
$password = array(
	'name'=>'password','placeholder'=>'cantidad de videos','type'=>'password'
	);
...
<br><br><br>
<input type="submit" name="submit" value="registrar" style="margin-left:10%;">
